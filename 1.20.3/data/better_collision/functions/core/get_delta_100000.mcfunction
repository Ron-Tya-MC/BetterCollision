...
# 座標内の位置を取得
    execute store result score #dx BCollision.core run data get entity @e[type=item_display,tag=Better_Collision_PosMarker,limit=1] Pos[0] 100000
    ...
    execute store result score #dz BCollision.core run data get entity @e[type=item_display,tag=Better_Collision_PosMarker,limit=1] Pos[2] 100000
