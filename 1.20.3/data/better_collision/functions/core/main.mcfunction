...
# ブロックごとに判定
    ...
    execute if block ~ ~ ~ #better_collision:10h_figure if score $dx BCollision.core matches 1826..8174 if score $dz BCollision.core matches 1826..8174 run return run function better_collision:core/8h_figure
    ...
    execute unless score $DisableDoor BCollision.core matches 1 if block ~ ~ ~ #minecraft:doors run return run function better_collision:core/doors
    ...
    execute unless score $DisableTrapdoor BCollision.core matches 1 if block ~ ~ ~ #minecraft:trapdoors run return run function better_collision:core/trapdoors

    execute if block ~ ~ ~ #better_collision:lanterns if score $dx BCollision.core matches 3176..6874 if score $dz BCollision.core matches 3176..6874 run return run function better_collision:core/lantern
