...
execute if block ~ ~ ~ minecraft:amethyst_cluster run return run function better_collision:core/specials/1.17/amethyst_cluster
execute if block ~ ~ ~ minecraft:big_dripleaf run return run function better_collision:core/specials/1.17/big_dripleaf
execute if block ~ ~ ~ minecraft:large_amethyst_bud run return run function better_collision:core/specials/1.17/large_amethyst_bud
execute if block ~ ~ ~ minecraft:medium_amethyst_bud run return run function better_collision:core/specials/1.17/medium_amethyst_bud
